...
describe('Shapes', () => {
    describe('Circle', () => {
        it('should return a circle svg with the correct user input', () => {
            ...
            expect(circle).toContain("<svg version=\"1.1\" width=\"300\" height=\"200\" xmlns=\"http://www.w3.org/2000/svg\"><circle cx=\"150\" cy=\"130\" r=\"80\" fill=\"pink\"/><text x=\"150\" y=\"150\" font-size=\"60\" text-anchor=\"middle\" fill=\"red\">img</text></svg>");
        });
    });
});
